...
plot(dd$time,dd$smooth, type="l", lwd=3,col=rgb(166/250,34/255,30/255),
     ...
     xlim = c(stime,etime),ylim=c(0,4500), axes = F)
abline(h=c(100,573*4,1002*4), col = "gray", lty = "dotted",lwd = 3)
text(x=rep(stime-times("00:10:00"),3),y=c(573*4,1002*4,4700)-150,adj = c(0,1),
...
axis(side=1,at=seq(stime,etime+times("01:00:00"),times("02:00:00")),
     labels= paste(seq(hours(stime),hours(etime)+1,2),":00",sep=""))
axis(2)
